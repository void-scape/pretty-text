//! Module for generating documentation for [`DynamicEffect`](super::DynamicEffect)s.
//!
...
impl quote::ToTokens for DynamicEffectSyntax<'_> {
    fn to_tokens(&self, tokens: &mut proc_macro2::TokenStream) {
        ...
        tokens.append_all(quote::quote! {
            pretty_text::dynamic_effects::syntax::DynamicEffectSyntax {
                name: #name,
                fields: &[#(#fields,)*],
...
impl quote::ToTokens for DynamicEffectFieldSyntax<'_> {
    fn to_tokens(&self, tokens: &mut proc_macro2::TokenStream) {
        ...
        tokens.append_all(quote::quote! {
            pretty_text::dynamic_effects::syntax::DynamicEffectFieldSyntax {
                name: #name,
                docs: #docs,
                default: #default,
                arguments: &[#(#arguments,)*],
...
impl quote::ToTokens for Argument<'_> {
    fn to_tokens(&self, tokens: &mut proc_macro2::TokenStream) {
        ...
        tokens.append_all(quote! {
            pretty_text::dynamic_effects::syntax::Argument {
                base: #base,
                shorthand: #shorthand,
            }
        });
